...
export default function BrandManagePage({ params }: { params: { brandSlug: string } }) {
  ...
  const handleCopyAffiliateLink = () => {
    const affiliateLink = `https://perchmerch.com/${brandSlug}?ref=affiliate`
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button onClick={() => router.push(`/${brandSlug}`)}>View Store</Button>
      </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <code className="bg-muted px-2 py-1 rounded text-sm">
                    https://perchmerch.com/{brandSlug}?ref=affiliate
                  </code>
